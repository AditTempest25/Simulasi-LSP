...
<head>
    ...
    <title>Edit Jadwal Penerbangan - Admin</title>
...
<body class="bg-gray-100">
    <div class="max-w-3xl mx-auto p-6">
        <div class="bg-white p-8 rounded shadow">
            <h2 class="text-2xl font-bold mb-6 text-center">Edit Jadwal Penerbangan</h2>
            @if ($errors->any())
            ...
            @endif
            <form action="{{ route('admin.jadwal-maskapai.update', $jadwal->id_jadwal) }}" method="POST">
                @csrf
                @method('PUT')
                <!-- Rute -->
                <div class="mb-4">
