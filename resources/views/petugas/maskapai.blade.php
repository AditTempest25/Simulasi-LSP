...
<head>
    ...
    <title>Halaman Petugas - Maskapai</title>
    ...
    <div class="flex h-screen">
        ...
        <div class="flex-1 p-6 bg-white rounded-lg shadow-md m-4">
            ...
            <div class="flex justify-between items-center mb-6">
                <h2 class="text-3xl font-bold text-blue-800">Maskapai (Petugas)</h2>
                <form method="GET" action="{{ route('petugas.maskapai') }}" class="flex items-center space-x-4">
                    ...
                    @if (request('q'))
                        <a href="{{ route('petugas.maskapai') }}" class="px-3 py-2 bg-gray-500 text-white rounded-lg">
            ...
            <div class="relative overflow-x-auto mt-6">
                <div class="mb-6">
                    <a href="{{ route('petugas.maskapai.create') }}"
                    ...
                    <tbody
                        ...
                        @foreach ($maskapai as $index => $m)
                            <tr class="border-b">
                                ...
                                <td class="px-6 py-4">
                                    <!-- Tombol Edit -->
                                    <a href="{{ route('petugas.maskapai.edit', $m->id_maskapai) }}"
                                        class="px-2 py-1 text-white bg-yellow-500 rounded-md hover:bg-yellow-600">
                                        <i class="fa-solid fa-pen-to-square me-2"></i>Edit
                                    </a>

                                    <!-- Tombol Delete -->
                                    <form action="{{ route('petugas.maskapai.destroy', $m->id_maskapai) }}"
