...
<body class="bg-gray-100">
    <div class="max-w-3xl mx-auto p-6">
        <div class="bg-white p-8 rounded shadow">
            ...
            @endif
            <form action="{{ route('petugas.data-pengguna.update', $pengguna->id) }}" method="POST">
                @csrf
                @method('PUT')
                <!-- Field Nama -->
                <div class="mb-4">
                ...
                <div class="mb-4">
                    ...
                    <input type="date" name="tanggal_lahir" id="tanggal_lahir" value="{{ $pengguna->tanggal_lahir }}"
                        required
                        class="w-full border border-gray-300 p-3 rounded focus:outline-none focus:ring-2 focus:ring-blue-500">
                </div>
                <!-- Field Alamat -->
                <div class="mb-4">
                    ...
                    <input type="text" name="alamat" id="alamat" value="{{ $pengguna->alamat }}" required
                        class="w-full border border-gray-300 p-3 rounded focus:outline-none focus:ring-2 focus:ring-blue-500">
                </div>
                <!-- Field Gender -->
                <div class="mb-4">
