...
<head>
    ...
    <title>Halaman Petugas - Rute</title>
    ...
    <div class="flex h-screen">
        ...
        <div class="flex-1 p-6 bg-white rounded-lg shadow-md m-4">
            <div class="flex justify-between items-center mb-6">
                <h2 class="text-3xl font-bold text-blue-800">Manajemen Rute (Petugas)</h2>
                <form method="GET" action="{{ route('petugas.rute') }}" class="flex items-center space-x-4">
                    ...
                    @if(request('q'))
                        <a href="{{ route('petugas.rute') }}" class="px-3 py-2 bg-gray-500 text-white rounded-lg">
            ...
            <div class="mb-6">
                <a href="{{ route('petugas.rute.create') }}"
                    ...
                    <tbody class="bg-white border border-gray-200 text-center">
                        @foreach ($rute as $index => $r)
                            <tr>
                                ...
                                <td class="px-6 py-4">
                                    <a href="{{ route('petugas.rute.edit', $r->id_rute) }}"
                                        class="px-2 py-1 text-white bg-yellow-500 rounded-md hover:bg-yellow-600">
                                        <i class="fa-solid fa-pen-to-square me-2"></i>Edit
                                    </a>
                                    <form action="{{ route('petugas.rute.destroy', $r->id_rute) }}" method="POST"
