...
<head>
    ...
    <title>Halaman Petugas - Users</title>
    ...
    <div class="flex flex-col lg:flex-row h-full">
        ...
        <div class="flex-1 p-6 bg-white rounded-lg shadow-md m-4">
            ...
            <div class="flex justify-between items-center mb-6">
                <h2 class="text-3xl font-bold text-blue-800">Data Pengguna (Petugas)</h2>
                <form method="GET" action="{{ route('petugas.data-pengguna') }}" class="flex items-center space-x-4">
                    <input type="text" name="q" value="{{ request('q') }}" placeholder="Search Pengguna..."
            ...
            <div class="relative overflow-x-auto mt-6">
                <div class="mb-6">
                    <a href="{{ route('petugas.data-pengguna.create') }}"
                ...
                <table class="w-full text-sm text-left rtl:text-right text-white dark:text-white">
                    ...
                    <tbody
                        class="bg-white border dark:bg-white dark:border-gray-700 border-gray-200 dark:text-black text-center  text-black">
                        @foreach ($penumpang as $index => $u)
                            <tr>
                                ...
                                <td class="px-6 py-4">
                                    <!-- Tombol Edit -->
                                    <a href="{{ route('petugas.data-pengguna.edit', $u->id) }}"
                                        class="px-2 py-1 text-white bg-yellow-500 rounded-md hover:bg-yellow-600">
                                        <i class="fa-solid fa-pen-to-square me-2"></i>Edit
                                    </a>
                                    <!-- Tombol Delete -->
                                    <form action="{{ route('petugas.data-pengguna.destroy', $u->id) }}" method="POST"
