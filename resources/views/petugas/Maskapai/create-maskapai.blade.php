...
<head>
    ...
    <title>Tambah Maskapai - Petugas</title>
...
<body class="bg-gray-100">
    <div class="max-w-3xl mx-auto p-6">
        <div class="bg-white p-8 rounded shadow">
            <h2 class="text-2xl font-bold mb-6 text-center">Tambah Maskapai (Petugas)</h2>
            @if ($errors->any())
            ...
            <form action="{{ route('petugas.maskapai.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
