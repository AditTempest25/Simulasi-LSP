    ...
    <aside class="w-64 bg-indigo-600 text-white flex flex-col">
        ...
        <nav class="flex-1 px-4 space-y-2">
            ...
            <a href="{{ route('petugas.data-pengguna') }}"
                class="flex items-center space-x-2 text-white p-2 rounded-lg transition
            {{ request()->routeIs('petugas.data-pengguna') ? 'bg-indigo-700' : 'hover:bg-indigo-500' }}">
        ...
        <div class="p-4">
            <a href="{{ route('logout') }}"
                class="flex items-center space-x-2 p-2 rounded hover:bg-red-500 transition-colors">
